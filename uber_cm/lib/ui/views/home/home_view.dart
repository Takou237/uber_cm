...
class _HomeViewState extends State<HomeView> {
  ...
  void _calculatePrice() {
    ...
    double price = selected.baseFare + (selected.pricePerKm * _rawDistanceKm);
    setState(() {
      _estimatedPrice = "${price.toStringAsFixed(0)} FCFA";
    });
  }
  ...
  void _drawRoute(LatLng destination) async {
    ...
    try {
      ...
      setState(() {
        _estimatedDistance = "${_rawDistanceKm.toStringAsFixed(1)} km";
        _calculatePrice();
